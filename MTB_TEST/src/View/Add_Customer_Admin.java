 ...
 * @author This PC
 */
public class Add_Customer_Admin extends javax.swing.JFrame {

    /**
     * Creates new form Customer_Register
     */
    public Add_Customer_Admin() {
        initComponents();
        date();
        time();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(312, 0, 590, 520));

        idLBL.setFont(new java.awt.Font("Times New Roman", 1, 30)); // NOI18N
        idLBL.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(idLBL, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 300, 60, -1));
    ...
    public void show(int id){
        ...
        Add_Customer_Admin.getFrames()[0].setVisible(false);
        load3.setVisible(true);
        load3.idLBL.setText(id+"");
    ...
    private void submitBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitBTNActionPerformed
        ...
        CustomerRegisterController.Formadmin(name,pword,tpnum, city, conpword);
        clearField();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_Customer_Admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Add_Customer_Admin().setVisible(true);
            }
        });
    }
